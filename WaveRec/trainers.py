...
class Trainer:
    ...
    def get_full_sort_score(self, epoch, answers, pred_list):
        ...
        post_fix = {
            "Epoch": epoch,
            "HR@1": '{:.4f}'.format(recall[0]), 
            "HR@5": '{:.4f}'.format(recall[1]), "NDCG@5": '{:.4f}'.format(ndcg[1]),
            "HR@10": '{:.4f}'.format(recall[2]), "NDCG@10": '{:.4f}'.format(ndcg[2])
        }

        self.logger.info(post_fix)

        return [recall[0], recall[1], ndcg[1], recall[2], ndcg[2]], str(post_fix)
